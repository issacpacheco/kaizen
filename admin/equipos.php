...
if (isset($_POST['alta']))
{
	...
	)" ))
	{
		...
		{
			$archivo = "images/equipos/".$ide.".jpg";
...
if (isset($_POST['editar']))
{
		...
		WHERE id = '".$_POST['editar']."' LIMIT 1"))
	{
		if ($_FILES['imagen']['type'] == "image/jpeg" && $_FILES['imagen']['size'] < 5000000)
		{
			$archivo = "images/equipos/".$_POST['editar'].".jpg";
			copy($_FILES['imagen']['tmp_name'],$archivo);
		}
	}
}
if (isset($_POST['eliminar']))
{
	...
	if (file_exists("images/equipos/".$_POST['eliminar'].".jpg"))
	{
		unlink("images/equipos/".$_POST['eliminar'].".jpg");
	}
}
?>
<!DOCTYPE html>
