                        ...
                        <div class="panel-body">
                            ...
                            <div class="">
                                <table class="table table-striped table-bordered table-hover" id="tabla">
                                    ...
                                    <tbody>
										<?php
										$consulta = mysqli_query($conexion,"SELECT * FROM $tabla WHERE nivel > 1");
										if ($_SESSION['nivel']==2)
										{
											$consulta = mysqli_query($conexion,"SELECT * FROM $tabla WHERE nivel > 2 AND id_equipo = '".$_SESSION['id_equipo']."'");
										}
										while ($d = mysqli_fetch_array($consulta))
										{
											...
											$consulta2 = mysqli_query($conexion,"SELECT * FROM nivel_usuarios WHERE id = '".$d['nivel']."'");
