                                    ...
                                    <tbody>
										<?php for($i = 0; $i < $cproductos; $i++){ ?>
                                            <tr>
                                                ...
                                                <td><button onclick="universalLoad(this)" data-postload="0" data-returnpage="pr-incentivos" data-form="" data-page="productos-edit" data-carpeta="ajax-edit" data-load="contenedor" data-valores="" data-id="<?php echo $productos["id"][$i]; ?>" type="submit" class="btn btn-md btn-success btn-block"><i class="fa fa-pencil"></i></button></td>
